...
class NcupLogger {
  ...
  void NcupLogInfo(Object NcupMessage) =>
      debugPrint('[NcupLogger] $NcupMessage');

  void NcupLogWarn(Object NcupMessage) =>
      debugPrint('[NcupLogger/WARN] $NcupMessage');

  void NcupLogError(Object NcupMessage) =>
      debugPrint('[NcupLogger/ERR] $NcupMessage');
}
...
// ============================================================================
// Сервис открытия ссылок: NcupLinker
// ============================================================================
...
class NcupLinker {
  static Future<bool> NcupOpen(Uri NcupUri) async {
    try {
      ...
      debugPrint('NcupLinker error: $NcupError; url=$NcupUri');
      try {
        return await launchUrl(
          NcupUri,
          mode: LaunchMode.externalApplication,
...
Future<void> NcupFcmBackgroundHandler(RemoteMessage NcupMessage) async {
  debugPrint("Ncup Spin ID: ${NcupMessage.messageId}");
  debugPrint("Ncup Spin Data: ${NcupMessage.data}");
}
...
class NcupSpy {
  ...
  void NcupStart({VoidCallback? NcupOnUpdate}) {
    ...
    NcupSdk?.startSDK(
      onSuccess: () =>
          NcupVault().NcupLoggerInstance.NcupLogInfo('NcupSpy started'),
      onError: (NcupCode, NcupMsg) => NcupVault()
          .NcupLoggerInstance
          .NcupLogError('NcupSpy error $NcupCode: $NcupMsg'),
    );
...
// ============================================================================
// Мост для FCM токена: NcupFcmBridge
// ============================================================================
